...
# 注意 `tf.function` 的使用
# 该注解使函数被“编译”: autograph, accelerate running speed
@tf.function
...
def train(dataset, epochs, generator, discriminator, generator_optimizer, discriminator_optimizer, cross_entropy, noise_dim,
          batch_size, checkpoint, checkpoint_prefix, seed):
    for epoch in range(epochs):
        start = time.time()

        for image_batch in dataset:
            train_step(image_batch, generator, discriminator, generator_optimizer, discriminator_optimizer, cross_entropy,
